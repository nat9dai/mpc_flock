...
pub const MPC_CONTROLLER_NUM_PARAMETERS: usize = 106;

/// Number of parameters associated with augmented Lagrangian
pub const MPC_CONTROLLER_N1: usize = 0;

/// Number of penalty constraints
pub const MPC_CONTROLLER_N2: usize = 500;
...
const CONSTRAINTS_XMIN :Option<&[f64]> = Some(&[-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,-1.0,-10.0,]);
const CONSTRAINTS_XMAX :Option<&[f64]> = Some(&[1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,1.0,10.0,]);
